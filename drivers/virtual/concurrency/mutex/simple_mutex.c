...
/* mutex operations */
static struct mutex mutex_vdev;
...
{
	// MUTEX lock , only one device can open at a time
	mutex_lock( &mutex_vdev );
...
static int char_dev_release(struct inode *inode, struct file* file)
{
	...
	// MUTEX  release , now other process can access 
	mutex_unlock( &mutex_vdev );
	return SUCCESS;

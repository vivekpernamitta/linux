...
#define MAJORNO 300
#define MINORNO 0
#define CHAR_DEV_NAME "vivek_module_wait"
...
/*
completion intitilaization variables. This macro is a struture that initilizaes variables
*/
...
*/	/*
	wait_event 
when dat_ready  --> 1 go else stop
	*/
	wait_event_interruptible ( my_wq, (atomic_read, (&data_ready)));	
